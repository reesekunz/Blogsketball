    ...
    <div className="section-1-container">
      ...
      <div className="section-1-column-1">
        ...
        <div className="section-1-third-img">
          <NavLink
            ...
            className="article-link"
          >
            <img className="third-img" src={BlogsketballIMG} alt="Steele Stadium" />
      ...
      <div className="section-1-main-img">
        <NavLink
          ...
          className="article-link"
        >
          <img className="main-img" src={BlogsketballIMG} alt="Pablo Cheating Scandals" />
      ...
      <div className="section-1-column-3">
        ...
        <div className="section-1-third-img">
          <NavLink
            ...
            className="article-link"
          >
            <img className="third-img" src={BlogsketballIMG} alt="Marky Dubios" />
            <div className="article-header">Third article</div>
          </NavLink>
        </div>
        {/* Fifth article  */}
        <div className="section-1-second-img">
          <NavLink
            ...
            className="article-link"
          >
            <img className="second-img" src={BlogsketballIMG} alt="Where are they now" />
            <div className="article-header">Second Article</div>
          </NavLink>
        </div>
      </div>
